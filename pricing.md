---
title: TheCoinLab pricing
description: One-time payment tiers for token deployment - no subscriptions. Basic, Advanced, and Launch, each adding more launch tooling.
---
...
ERC-20 or SPL token, custom configuration, mintable and burnable supply, and verified deployment.

## Advanced - EUR 49

Everything in Basic, plus the tax engine, anti-whale limits, airdrop tools, and the management dashboard.
